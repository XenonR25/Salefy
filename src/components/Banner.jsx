...
const Banner = () => {
    return (
        <div className=" bg-cover bg-center min-h-[550px] flex items-center justify-center py-12 sm:py-0">
            <div className="container">
                <div className="grid grid-col-1 sm:grid-cols-2 gap-6 items-center">
                    <div data-aos="zoom-in" >
                        <img src={BannerImage} alt="" className="max-w-[400px] h-[350px] w-full mx-auto drop-shadow-[-10px_10px_12px_rgba(0,0,0,1)] object-cover rounded-lg"/>
                    </div>
